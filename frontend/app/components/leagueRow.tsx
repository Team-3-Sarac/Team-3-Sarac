  ...
  return (
    <div className="flex items-center justify-between gap-4 px-6 py-6.5 transition-colors hover:bg-[#161616]">
      <div className="flex items-center gap-3 min-w-0">
        <span className="inline-flex h-6 w-9 shrink-0 items-center justify-center rounded-md border border-white/8 bg-white/4 text-[10px] font-semibold text-neutral-400">
          {code}
        </span>
